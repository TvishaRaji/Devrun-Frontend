...
export class ApiService {
  ...
  search(query: string): Observable<BookDetail[]> {
    ...
    return this.http.get<any>(queryUrl).pipe(map(response => {
      return response['items'].map((item: { volumeInfo: { authors: any; title: any; infoLink: any; imageLinks: { thumbnail: any; } ;id: any| undefined; }; }) => {
    ...
    // key = "AIzaSyAmOQbjYmGrAAqF8Yb8AlVsDEr22heQnhI";
